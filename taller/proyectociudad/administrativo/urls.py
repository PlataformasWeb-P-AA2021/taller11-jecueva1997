...
urlpatterns = [
        ...
        path('crear_edificio', views.crear_edificio, 
            name='crear_edificio'),
        path('editar_edificio/<int:id>', views.editar_edificio, 
            name='editar_edificio'),
        path('eliminar_edificio/<int:id>', views.eliminar_edificio, 
            name='eliminar_edificio'),

        # departamentos
        path('crear_departamento', views.crear_departamento, 
        ...
        path('crear_departamento_edificio<int:id>', views.crear_departamento_edificio, 
